...
public class FlowEdge {
    ...
    public void addResidualFlowTo(int vertex, double delta) {
        if (Math.abs(delta) < FLOATING_POINT_EPSILON) {
            delta = 0.0;
        }
    ...
    public boolean equals(Object o) {
        ...
        return v == flowEdge.v && w == flowEdge.w && Double.compare(flowEdge.capacity, capacity) == 0 && Double.compare(flowEdge.flow, flow) == 0;
    }
